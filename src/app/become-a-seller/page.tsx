...
const faqs = [
  {
    question: 'What is KaamKarta?',
    answer:
      'KaamKarta is a freelance platform that leverages blockchain technology to connect businesses with freelancers, ensuring secure and efficient collaboration.',
  },
  {
    question: 'How can I get started as a freelancer on KaamKarta?',
    answer:
      'To get started as a freelancer, sign up for an account on KaamKarta, create a blockchain-secured profile, showcase your skills, and start offering your services to potential clients.',
  },
  {
    question: 'How do I hire a freelancer on KaamKarta?',
    answer:
      'To hire a freelancer, browse through verified profiles, select a service you need, set up a smart contract for payment escrow, and work with the freelancer to bring your project to life.',
  },
];
      ...
      <section className="py-16">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                quote: 'People love our logo, and we love KaamKarta.',
                author: 'Jennifer Gore, CEO of Weleet',
              },
              {
                quote:
                  'KaamKarta is an amazing resource for anyone in the startup space.',
                author: 'Adam Mashaal, CEO of Mashfeed',
              },
              {
                quote:
                  'There is no way I could have produced anything without KaamKarta.',
                author: 'Christopher Sunami, Music Producer',
              },
              {
                quote:
                  'KaamKarta enables me to quickly, efficiently and cost-effectively get things done.',
