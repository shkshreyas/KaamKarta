  ...
  return (
    <footer className="px-4 divide-y bg-gray-50">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start">
              <SocialIcon
                url="https://www.facebook.com/shkshreyas"
                fgColor="#000000"
                bgColor="transparent"
              />
              <SocialIcon
                url="https://www.instagram.com/shkshreyas"
                fgColor="#000000"
                bgColor="transparent"
              />
              <SocialIcon
                url="https://www.twitter.com/shkshreyas"
                fgColor="#000000"
                bgColor="transparent"
              />
            </div>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">
        © {new Date().getFullYear()} Decentra Learn. All rights reserved.
      </div>
    </footer>
  );
};
